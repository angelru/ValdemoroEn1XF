...
# History
He decidido publicar el código fuente de mi primera aplicación en **Xamarin Forms**, es un proyecto que empecé con mucha ilusión por el **2015** en **PhoneGap**, pero en **2017** decidí pasarlo a **Xamarin Forms**, tiene muchas partes que no están actualizadas, y además, hay que enfocarlas de maneras diferentes, pero cuando tenga tiempo ire mejorando el código acorde con los tiempos que corren.
